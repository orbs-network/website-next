...
const PATH = '/liquidity-hub-terms-of-use'
...
export default function LiquidityHubTermsOfUse() {
  return <LegalPage path={PATH} locale="en" namespace="pages.liquidityHubTerms" />
}
